...
- [ ] The project will focus on creating light graphics, showing how the light will reflect off of different objects like mirrors and other reflective items compared to how it will. General description of the goal or purpose.  What are you trying to make happen or solve?  Feel free to design projects which utilize content from other courses (simulations, for example), address and analyze real daata and problems (the environment, anyone?), or have other useful impacts.
